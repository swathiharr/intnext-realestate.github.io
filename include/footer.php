...
<footer class="footer mt-auto mt-4">
    <h5>Get luxurious, stylish, beautiful homes at <br>Horizon, Elevate Your Living & Experience</h5>
    <br><br>
    ...
    <a href="#" style="padding-left: 2px; padding-right: 2px;" target="_blank">
      <svg xmlns="http://www.w3.org/2000/svg" height="1.3em" viewBox="0 0 496 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
    ...
    <a href="#" style="padding-left: 2px; padding-right: 2px;" target="_blank">
      <svg xmlns="http://www.w3.org/2000/svg" height="1.3em" viewBox="0 0 576 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
